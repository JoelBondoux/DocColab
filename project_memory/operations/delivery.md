...
### 3. Production (release-ready) — `production` 🔒 protected

PyPI package distribution through `.github/workflows/release.yml`. The repository
workflow is configured; the first release remains gated on the external PyPI
trusted-publisher registration and protected GitHub `pypi` environment.
...
_Last updated: 2026-07-27T12:00:00Z._
