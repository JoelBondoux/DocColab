...
def _default_rewrite_operations() -> list[RewriteOperation]:
    return ["improve_clarity", "improve_structure"]
...
class AIConfig(StrictModel):
    ...
    auto_rewrite_human_changes: bool = True
    operations: list[RewriteOperation] = Field(default_factory=_default_rewrite_operations)
    tone: str | None = None
